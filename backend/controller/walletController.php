...
?>SESSION['error'] = 'Invalid balance input'; header('Location: ../../home.php'); exit();
}
$user_id=$_SESSION['user_id'];
$balance=floatval($_POST['balance']);
if($balance <= 0){
...
?>SESSION['error'] = 'Balance cannot be less than 0'; header('Location: ../../home.php'); exit();
}
...
?>
SESSION['error'] = 'Failed to update wallet balance'; header('Location: ../home.php'); exit();
}
?>SESSION['error'] = 'Invalid balance input'; header('Location: ../../home.php'); exit();
}
$user_id=$_SESSION['user_id'];
